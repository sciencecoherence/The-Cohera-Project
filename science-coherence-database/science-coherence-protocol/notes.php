...
<title>Notes — TRANSMISSION</title>
...
<header class="site-head">
  ...
  <nav>
    <a href="./">Feed</a>
    <a href="notes.php" class="current">Notes</a>
...
<div class="meta-bar">
  <span>Framework notes &amp; papers rendered for the site</span>
</div>

<main>

<?php if (!$posts): ?>
  <div class="empty-state">No notes published yet.</div>
<?php endif; ?>
...
<aside class="attribution">
  ...
  All transmissions and notes on this site have been received and given by the author. They have <b>not</b> been generated by artificial intelligence. Claude has been used only for building the website that hosts them, and for transcribing into text the transmissions originally recorded in audio.
</aside>
